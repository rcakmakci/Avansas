const AnaKatagoriProducts = {
    "matbaa": [
        {
            "produtKod" : "95503",
            "productName": " Kartvizit - Kendi Tasarımını Yükle ",
            "imgUrl": "https://cdnsta.avansas.com/mnresize/300/-/urun/95503/kartvizit-zoom-1.jpg",
            "productInfo1" : "Ayarlanabilir yükseklik",
            "productInfo2" : "Bol çeşitli baskı seçeneği",
            "price" : "1.20",

        },
        {
            "produtKod" : "105619",
            "productName": " Trodat 4913 58x22 mm Kaşe",
            "imgUrl": "https://cdnsta.avansas.com/mnresize/300/-/urun/105619/kase-zoom-1.jpg",
            "productInfo1" : "58x22 mm ölçülerinde",
            "productInfo2" : "Kaliteli malzeme",
            "price" : "141.00",
        },
        {
            "produtKod" : "101419",
            "productName": "Tükenmez Promosyon Kalemi KS8",
            "imgUrl": "https://cdnsta.avansas.com/mnresize/300/-/urun/101419/promosyon-kalem-zoom-1.jpg",
            "productInfo1" : "Özelleştirilebilir baskılı kalem",
            "productInfo2" : "Zengin renk seçenekleri",
            "price" : "99.00",
        },
        {
            "produtKod" : "95290",
            "productName": " Karton Bardak Çift Logo",
            "imgUrl": "https://cdnsta.avansas.com/mnresize/300/-/urun/95503/kartvizit-zoom-1.jpg",
            "productInfo1" : "Çift logo baskılı",
            "productInfo2" : "7 oz 207 ml",
            "price" : "75,00",
        }
    ],
    ...
    "ofis": [
        {
            ...
            "productInfo2" : "Yazım Kapasitesi: 500 m",
            "price" : "72,00",
            "degerlendirme" :"47"
        ...
        },
        {
            ...
            "productInfo2" : "Karton koli, çuval ve naylon yüzeyler için ideal",
            "price" : "194,10",
            "degerlendirme" :"26"
        },
        {
        ...
        },
        {
            ...
            "productInfo2" : "A4 boyutlu 21.6 cm x 30 cm",
            "price" : "50,32",
            "degerlendirme" :"170"
        }
    ],
    ...
    "kağıt": [
        {
            ...
            "productInfo2" : "Çift taraflı baskıya uygun",
            "price" : "409,90",
            "degerlendirme" :""
        ...
        },
        {
            ...
            "productInfo2" : "Metrekare ağırlığı 110 gram",
            "price" : "87,73",
            "degerlendirme" :"20"
        ...
        },
        {
            ...
            "productInfo2" : "1 kolide 5 paket A4 (1250 yaprak)",
            "price" : "299,89",
            "degerlendirme" :"160"
        ...
        },
        {
            ...
            "productInfo2" : "Yazarkasa ve poslara uygun",
            "price" : "52,85",
            "degerlendirme" :"33"
    ...
    "kartuş": [
        {
            ...
            "productInfo2" : "Üstün baskı kapasitesi ile yüksek kalitede baskılar",
            "price" : "1.185,98",
            "degerlendirme" :"4"
        ...
        },
        {
            ...
            "productInfo2" : "Yüksek kalitede belgeler elde edin",
            "price" : "2.935.25",
            "degerlendirme" :""
        ...
        },
        {
            ...
            "productInfo2" : "Yüksek kaliteli baskı",
            "price" : "188,27",
            "degerlendirme" :"3"
    ...
    "tamizlik": [
        ...
        },
        {
            ...
            "productInfo2" : "Mükemmel Hijyen Ve Çam Ferahlığı",
            "price" : "101,39",
            "degerlendirme" :"148"
    ...
    "teknoloji": [
        {
            ...
            "productInfo2" : "Kişisel dosyalarda parala koyulması ve şifreleme",
            "price" : "114,04 TL",
            "degerlendirme" :"13"
        ...
        },
        {
            ...
            "productInfo2" : "3 Kanatlı pervane",
            "price" : "549,00 TL",
            "degerlendirme" :"15"
    ...
    "gıda": [
        ...
        },
        {
            ...
            "productInfo1" : "2 kg",
            "productInfo2" : "Yumuşak içim keyfi",
            "price" : "333,23 TL",
            "degerlendirme" :"73"
        ...
        },
        {
            ...
            "productInfo2" : "Her zaman taze ve lezzetli",
            "price" : "159,11 TL",
            "degerlendirme" :"106"
        ...
        },
        {
            ...
            "productInfo2" : "Demlik süzen poşet",
            "price" : "424,28 TL",
            "degerlendirme" :"62"
...
$(function() {
    ...
    function loadProducts(productListKey) {
        ...
        $.each(products, function(i, product) {
            ...
            mainProductTamplate.find(".menu-product-name h2").text(product.productName);
            mainProductTamplate.find(".menu-product-info li:eq(0) span").text(product.productInfo1);
            mainProductTamplate.find(".menu-product-info li:eq(1) span").text(product.productInfo2);
            mainProductTamplate.find(".price span").text(product.price);

            if(product.degerlendirme) {
                mainProductTamplate.find(".evaluation-count").text(product.degerlendirme + " Değerlendirme");
            } else {
                mainProductTamplate.find(".menu-product-evaluation").remove();
            }

            if(productListKey === "matbaa") {
                mainProductTamplate.find(".menu-product-evaluation").remove();
                mainProductTamplate.find(".menu-product-add").remove();
            } else {
